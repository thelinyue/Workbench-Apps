...
describe('分析中心独立应用包', () => {
  it('拥有独立版本和独立运行时入口', async () => {
    ...
    expect(manifest).toMatchObject({ id: 'analysis-center', version: '2.0.1', hostApiVersion: '1.1', minWorkbenchVersion: '0.1.7', window: { defaultSize: { width: 1200, height: 800 }, minSize: { width: 800, height: 560 } }, runtime: { rendererEntry: 'renderer/index.html', backendEntry: 'backend/entry.js' } });
