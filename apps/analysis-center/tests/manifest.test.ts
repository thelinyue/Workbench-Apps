...
describe('分析中心独立应用包', () => {
  it('拥有独立版本和独立运行时入口', async () => {
    ...
    expect(manifest).toMatchObject({ id: 'analysis-center', version: '1.1.0', minWorkbenchVersion: '0.1.2', runtime: { rendererEntry: 'renderer/index.html', backendEntry: 'backend/entry.js' } });
